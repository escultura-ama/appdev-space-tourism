 ...
 export default function Page() {
  return (
    <div className="bg-home-bg relative min-h-screen flex flex-col overflow-x-hidden">
      ...
      {/* Main Container */}
      <div className="flex-1 flex flex-col lg:flex-row items-center lg:items-end justify-between px-6 md:px-40 lg:px-36 pb-24 lg:pb-32 md:mb-16 md:ml-18">
        ...
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left w-full lg:max-w-[540px] mt-24 md:mt-48 lg:mt-10">
          <h1 className="font-barlow condensed,sans serif text-primaryText tracking-wider font-normal text-[px] md:text-xl lg:text-3xl lg:text-widest uppercase">
            So, you want to travel to
          </h1>
          
          <h2 className="font-bellefair font-normal text-white text-[80px] md:text-[170px] leading-[100px] md:leading-[150px] lg:leading-[172px] mt-4 md:mt-6 uppercase lg:mb-10">
            Space
          </h2>
          
         <p className="font-barlow,sans-serif text-primaryText text-[15px] md:text-[20px] lg:text-[20px] leading-[25px] md:leading-[28px] lg:leading-[32px] mt-4 md:mt-6 mx-auto lg:mx-0 max-w-[327px] md:max-w-[444px] lg:max-w-none">
  ...
  space and not hover kind of on the edge of it. Well sit back, and relax because we’ll give you a truly out of this world experience!
        ...
        <div className="mt-20 md:mt-40 lg:mt-0 flex items-center justify-center">
          <button
